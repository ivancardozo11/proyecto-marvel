...
api.findSeries("avengers")
  ...
  .then(function(serie) {
    ...
    try {
      for (
        var _iterator = characters[Symbol.iterator](), _step;
...
function renderCharacter(character) {
  ...
  return (
    ...
    '" alt="wolverine" class="Card-image">\n      <div class="Card-description">' +
    character.description +
    '</div>\n      <div class="Card-attack" data-attack="' +
    attackPoints +
    '">' +
    attackPoints +
    ' puntos de ataque</div>\n    </div>\n    <div class="Card-backface"> </div>\n  </div>'
  );
}
